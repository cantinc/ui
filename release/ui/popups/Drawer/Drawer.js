...
let drawersCount = 0;
function Drawer(_a = {}) {
    var { onclose, size = 388, placement = 'left', style, ref = new dom.Ref() } = _a, props = tslib.__rest(_a, ["onclose", "size", "placement", "style", "ref"]);
    ...
    return ({type:'delay',props:{ref:hide,hide:300},children:[{type:'div',props:{...overlayHack,ontouchstart:handleTouchStart,ontouchmove:handleTouchMove,ontouchend:handleTouchEnd,style:Object.assign(Object.assign({}, style), { '--ui-drawer-size': `${size}px`, '--ui-drawer-touch-hide': () => `${touchHide.value}` }),class:() => {
        ...
        }},children:[{type:Flex.Flex,props:{...props,ref:ref,class:() => styles.content},children:[children]},{type:Icon.Icon,props:{onclick:() => onclose === null || onclose === void 0 ? void 0 : onclose('close'),icon:'cross',class:() => styles.close}}]}]});
}

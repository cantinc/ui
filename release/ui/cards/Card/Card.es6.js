...
function Card(_a = {}) {
    var { onclick, clickable = !!onclick, loading, preventAnimation, width, height, style, radius = 8 } = _a, props = __rest(_a, ["onclick", "clickable", "loading", "preventAnimation", "width", "height", "style", "radius"]);

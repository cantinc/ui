...
function FormSelector(_a) {
    ...
    const { '': children, before, after, hint } = jsx.useSlots();
    ...
    return ({type:Selector.Selector,props:{...props,inputRef:element,oninput:(value) => {
        ...
        },error:() => Boolean(error.value),value:() => state.value,disabled:(() => { var _a; return (_a = dom.use(disabled)) !== null && _a !== void 0 ? _a : loading.value; })},children:[before && {type:'slot',props:{name:'before'},children:[before]},' ',after && {type:'slot',props:{name:'after'},children:[after]},{type:'slot',props:{name:'hint'},children:[() => error.value || hint]},children]});
}

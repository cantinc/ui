...
function FormInputNumber(_a) {
    ...
    const { state, error, element } = useField.useField(0, inputRef);
    return ({type:InputNumber.InputNumber,props:{...props,inputRef:element,oninput:(value) => {
            state.value = value;
            error.value = '';

...
function InputNumber(_a = {}) {
    ...
    return ({type:Input,props:{type:'number',value:() => String(use(value)),oninput:value => oninput === null || oninput === void 0 ? void 0 : oninput(Number(value)),props:Object.assign(Object.assign({}, props.props), { input: Object.assign({ step: inject(step, String) }, (_b = props.props) === null || _b === void 0 ? void 0 : _b.input) }),...props,class:styles},children:[{type:'slot',props:{name:'before'},children:[{type:Icon,props:{icon:'minus',onclick:decrease,class:() => styles.minus}}]},{type:'slot',props:{name:'after'},children:[{type:Icon,props:{icon:'plus',onclick:increase,class:() => styles.minus}}]},hint && {type:'slot',children:[hint]}]});
}

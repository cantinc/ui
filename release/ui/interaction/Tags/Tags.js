...
function Tags(_a = {}) {
    ...
    return ({type:Flex.Flex,props:{gap:8,...props},children:[values === null || values === void 0 ? void 0 : values.map(tag => ({type:Tag.Tag,props:{...tag,checked:() => {
            ...
            },type:multiple ? 'checkbox' : 'radio'}})),' ',children]});
}
